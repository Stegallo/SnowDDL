from snowddl.blueprint import AccountObjectIdent, Ident, WarehouseBlueprint
    ...
    def process_warehouse(self, f: ParsedFile):
        for warehouse_name, warehouse in f.params.items():
            bp = WarehouseBlueprint(
                ...
                resource_monitor=Ident(warehouse["resource_monitor"])
